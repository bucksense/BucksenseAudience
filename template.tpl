...
[
  {
    "help": "This is the Audience ID you want to create. You can get this value from the Bucksense platform",
...
if (query('inject_script', newurl)) {
inject(newurl, onSuccess, onFailure);
} else {
